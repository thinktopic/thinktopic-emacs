...
;;
;; "and he'd still see the matrix in his sleep, bright lattices of
;;logic
...
;;     (region ((t (:foreground "black" :background "#7F073F"))))
     ...
     ;; (rainbow-delimiters-depth-6-face ((t (:foreground "slate
     ;; blue"))))
     ;; (rainbow-delimiters-depth-7-face ((t (:foreground "yellow"))))
     ;; (rainbow-delimiters-depth-8-face ((t (:foreground "light
     ;; blue"))))
     ;; (rainbow-delimiters-depth-9-face ((t (:foreground
     ;; "#7f7f7f"))))
     ;; (rainbow-delimiters-unmatched-face ((t (:foreground
     ;; "white"))))
